          ...
          <div className="mt-2 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="w-full flex items-center justify-center mt-4">
                <label className="flex items-center gap-1 text-base text-ascent-2 hover:text-ascent-1 cursor-pointer my-4" htmlFor="imgUpload">
                  <input type="file" className="hidden" id="imgUpload" onChange={(e) => handleSelect(e)} accept=".jpg, .png, .jpeg" multiple={true} />
                  <BiImages />
            ...
            <div className="bg-gray-50 py-6 sm:flex sm:flex-row-reverse gap-4">
              {uploading ? (
                ...
                <Button label="Submit" type="submit" className="submit-btn bg-blue-600 px-8 text-sm font-semibold text-white hover:bg-blue-700 sm:w-auto cursor-pointer" />
              )}

              <Button type="button" className="cancel-btn bg-white px-5 text-sm font-semibold text-gray-900 sm:w-auto cursor-pointer" onClick={() => setOpen(false)} label="Cancel" />
            </div>
          </div>
        </form>
      </ModalWrapper>
